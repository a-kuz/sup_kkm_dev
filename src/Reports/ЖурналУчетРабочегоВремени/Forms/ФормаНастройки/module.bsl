...
Если ПараметрыСеанса.РаспределенныйРежим Тогда
	СписокВариантовФормирования.Добавить("ИнформационнаяБаза", "По информационным базам");
КонецЕсли;
СписокВариантовФормирования.Добавить("Сотрудник", "Сотрудник");
Если глВерсия > 2 Тогда
	СписокВариантовФормирования.Добавить("Должность", "Должность");
КонецЕсли; 
...
КонецЕсли;
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Сотрудник")         , Новый ОписаниеТипов("СправочникСсылка.Сотрудники"));
Если глВерсия > 2 Тогда
	СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Должность")         , Новый ОписаниеТипов("СправочникСсылка.Должности"));
КонецЕсли; 
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Ответственный")     , Новый ОписаниеТипов("СправочникСсылка.Сотрудники"));
