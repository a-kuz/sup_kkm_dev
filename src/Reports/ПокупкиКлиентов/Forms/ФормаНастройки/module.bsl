...
Процедура КПодробномуВиду(Элемент)
	...
	Если ПоТоварам Тогда
		...
		ГруппировкаПоКонтрагенту = ГруппировкаПоТовару.Структура.Добавить(Тип("ГруппировкаКомпоновкиДанных")); 
	Иначе
	...
	//  клиент
	ГруппировкаПоКлиенту = ГруппировкаПоКонтрагенту.Структура.Добавить(Тип("ГруппировкаКомпоновкиДанных")); 
