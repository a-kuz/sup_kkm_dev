...
Процедура ПриОткрытии()
	...
	Если мИсходнаяТаблица = "СписокФильтров" Тогда
		...
		Пока Сч < ТаблицаИспользуемыеФильтры.Количество() Цикл
			...
			КонецЕсли;
		КонецЦикла;
	ИначеЕсли мИсходнаяТаблица = "СписокВидовДокументов" Тогда
		...
		ТаблицаИспользуемыеФильтры = мТаблицаФильтры.СкопироватьКолонки();
		
		Заголовок="Виды документов";
		
		Для Каждого К Из мСписокВидовДокументов Цикл
			НоваяСтрока = ТаблицаИспользуемыеФильтры.Добавить();
			НоваяСтрока.ПредставлениеПоля = К.Представление;
			НоваяСтрока.ИмяПоля           = К.Значение;
		КонецЦикла;
