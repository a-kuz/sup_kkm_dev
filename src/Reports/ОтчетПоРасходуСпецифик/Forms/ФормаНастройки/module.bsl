...
Процедура ПриОткрытии()
	...
	ЭлементыФормы.ВариантыФормирования.Значение = СписокВариантовФормирования.НайтиПоЗначению(ВариантыФормирования).Представление;
...
// Обработчик события НачалоВыбораИзСписка поля ВариантыФормирования.
//
Процедура ВариантФормированияНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	Если Не ВыбранноеЗначение = Неопределено Тогда
		...
		ВариантыФормирования = ВыбранноеЗначение.Значение;
	КонецЕсли;
...
Процедура КПодробномуВиду(Элемент)
	...
	ГруппировкаПоВозврату = ГруппировкаРодитель.Структура.Добавить(Тип("ГруппировкаКомпоновкиДанных"));
	
	ПолеГруппировки                = ГруппировкаПоВозврату.ПоляГруппировки.Элементы.Добавить(Тип("ПолеГруппировкиКомпоновкиДанных"));
	ПолеГруппировки.Использование  = Истина;
	ПолеГруппировки.ТипГруппировки = ТипГруппировкиКомпоновкиДанных.Элементы;
	Если ВариантыФормирования = "ПоСпецификам" Тогда
		ПолеГруппировки.Поле           = Новый ПолеКомпоновкиДанных("Специфика");
	ИначеЕсли ВариантыФормирования = "ПоБлюдам" Тогда
		ПолеГруппировки.Поле           = Новый ПолеКомпоновкиДанных("Товар");
	КонецЕсли;
	
	НовоеВыбранноеПоле = ГруппировкаПоВозврату.Выбор.Элементы.Добавить(Тип("АвтоВыбранноеПолеКомпоновкиДанных")); 

	ГруппировкаПоТовару = ГруппировкаПоВозврату.Структура.Добавить(Тип("ГруппировкаКомпоновкиДанных"));
...
СписокВариантовФормирования.Добавить("ПоСпецификам", "По спецификам");
СписокВариантовФормирования.Добавить("ПоБлюдам", "По блюдам");
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Специфика")                  , Новый ОписаниеТипов("СправочникСсылка.Специфики"));
