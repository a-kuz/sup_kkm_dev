...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	//УстановитьНастройкиВФормеОтчета(ВладелецФормы);
...
Процедура ТабличноеПолеВидыОтбораПодборЗначенияНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	КонецЕсли;
	  ...
	  //  
	  //  //ИнтерфейсАдмина.ЗаполнитьСписокДнейНедели(Элемент.Значение, мЧислоКогдаВПродаже);

	  //  ФормаВыбора.СписокРеквизитов = Элемент.Значение;
	  //  
...
СписокВариантовФормирования.Добавить("МестоРеализации", "по местам реализации");
...
КонецЕсли;
СписокВариантовФормирования.Добавить("Категория", "по категориям");
СписокВариантовФормирования.Добавить("Официант", "по официантам");
СписокВариантовФормирования.Добавить("ОфициантДозаказа", "по официантам дозаказа");
СписокВариантовФормирования.Добавить("ГруппаПечати", "по группам печати");
СписокВариантовФормирования.Добавить("Клиент", "по клиентам");    
СписокВариантовФормирования.Добавить("Контрагент", "по контрагентам");
СписокВариантовФормирования.Добавить("ТипЦен", "по типам цен");
...
СписокВариантовГруппировкиБлюд.Добавить("Без расшифровки по блюдам");
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("ОфициантДозаказа")           , Новый ОписаниеТипов("СправочникСсылка.Сотрудники"));
