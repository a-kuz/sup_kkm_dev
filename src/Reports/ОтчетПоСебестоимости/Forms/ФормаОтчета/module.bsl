...
Процедура УстановитьПараметрыПоУмолчанию()
	...
	СхемаКомпоновкиДанных.Параметры.СРаспределением.Значение = СРаспределением;
...
Процедура ПриОткрытии()
	...
	Если глВерсия = 3  Тогда
		...
		СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос = СтрЗаменить(СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос,"И ЗаказТовары.Количество <> 0",
	...
	Если Не ЗначениеЗаполнено(ВариантФормирования) Тогда
		ВариантФормирования = "МестоРеализации";
	КонецЕсли;	
	
	Если Не ЗначениеЗаполнено(РасчетПроцентов) Тогда
		РасчетПроцентов = 1;
	КонецЕсли;
