...
Процедура ВариантФормированияНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	...
	Если Не ВыбранноеЗначение = Неопределено Тогда
		//Элемент.Данные = ВыбранноеЗначение.Представление;
...
СписокВариантовФормирования.Добавить("Сводный отчет",    "Сводный отчет");
СписокВариантовФормирования.Добавить("НаМесто",          "Скидки на место");
СписокВариантовФормирования.Добавить("НаКлиента",        "Скидки на клиента");
СписокВариантовФормирования.Добавить("НаТовар",          "Скидки на товар");
СписокВариантовФормирования.Добавить("Ручная",           "Ручные скидки");
СписокВариантовФормирования.Добавить("НаЗаказ",          "Скидки на заказ");
СписокВариантовФормирования.Добавить("НаВариантОплаты",  "Скидки на вариант оплаты");
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Тип"), Новый ОписаниеТипов("ПеречислениеСсылка.ТипыСкидок"));
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Скидка"), Новый ОписаниеТипов("СправочникСсылка.Скидки"));
