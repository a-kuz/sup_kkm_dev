...
Процедура ПриОткрытии()
	...
	Если НЕ ЗначениеЗаполнено(ВариантГруппировкиБлюд) Тогда
		ВариантГруппировкиБлюд = "Только блюда без групп";
	КонецЕсли;
...
СписокВариантовФормирования.Добавить("ОбщийРасход", "Общий расход");
СписокВариантовФормирования.Добавить("Категория", "Расход блюд по категориям");
СписокВариантовФормирования.Добавить("Официант", "Расход блюд по официантам");
СписокВариантовФормирования.Добавить("ОфициантДозаказа", "Расход блюд по официантам дозаказа");
СписокВариантовФормирования.Добавить("МестоРеализации", "Расход блюд по местам реализации");
Если ПараметрыСеанса.РаспределенныйРежим Тогда
	СписокВариантовФормирования.Добавить("ИнформационнаяБаза", "Расход блюд по информационным базам");
КонецЕсли;
СписокВариантовФормирования.Добавить("ГруппаПечати", "Расход блюд по группам печати");
СписокВариантовФормирования.Добавить("Клиент", "Расход блюд по клиентам");    
СписокВариантовФормирования.Добавить("Час",    "Время");
СписокВариантовФормирования.Добавить("ПосадочноеМесто", "Посадочное место");
СписокВариантовФормирования.Добавить("ТипЦен", "Расход блюд по типам цен");
...
СписокВариантовГруппировкиБлюд = Новый СписокЗначений;
СписокВариантовГруппировкиБлюд.Добавить("Только блюда без групп");
СписокВариантовГруппировкиБлюд.Добавить("Только группы без блюд");
СписокВариантовГруппировкиБлюд.Добавить("Группы блюд и блюда");
ЭлементыФормы.ВариантГруппировкиБлюд.СписокВыбора = СписокВариантовГруппировкиБлюд;
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("Группа печати")              , Новый ОписаниеТипов("СправочникСсылка.ГруппыПечати"));
