...
Процедура ПриОткрытии()
	...
	Если глВерсия = 3  Тогда
		...
		СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос = СтрЗаменить(СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос, "ПО ЗаказТовары.Ссылка = ЗаказДопИнф.Заказ",
		...
		СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос = СтрЗаменить(СхемаКомпоновкиДанных.НаборыДанных.НаборДанных1.Запрос,"ИСТИНА",
		"(НЕ ЗаказТовары.Ссылка.Доставка
	...
	Если Не ЗначениеЗаполнено(ВариантФормирования) Тогда 
		ВариантФормирования = "ГруппаПечати";	
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ПоЗаказам) Тогда 
		ПоЗаказам = 0;	
	КонецЕсли;
