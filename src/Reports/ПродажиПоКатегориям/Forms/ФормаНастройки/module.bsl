...
// Обработка события ПриИзменении флажка ДопГруппировка.
//
...
СписокВариантовФормирования.Добавить("ГруппаОплаты", "По группам оплаты");
...
СоответствиеОтборов.Вставить(Новый ПолеКомпоновкиДанных("ГруппаОплаты")   , Новый ОписаниеТипов("СправочникСсылка.ГруппыОплаты"));
