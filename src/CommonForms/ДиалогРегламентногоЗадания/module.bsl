...
Перем мВозможностьИзменятьМетаданные Экспорт; // Признак изменения метаданных.
Перем мЗаписыватьДанныеЗаданияПриОК Экспорт;  // Если Истина, то будет производиться запись данных задания.
