...
Процедура УстановитьРодителя(Знач НазваниеРегиона, Знач НазваниеРайона, Знач НазваниеГорода, Знач НазваниеНаселенногоПункта) Экспорт
	...
	Район = киПолучитьАдресныйЭлемент(киОбрезатьСокращение(НазваниеРайона), 2, КодРодителяРодителя);
	...
	Город = киПолучитьАдресныйЭлемент(киОбрезатьСокращение(НазваниеГорода), 3, КодРодителяРодителя);
	...
	НаселенныйПункт = киПолучитьАдресныйЭлемент(киОбрезатьСокращение(НазваниеНаселенногоПункта), 4, КодРодителяРодителя);
	...
	КодУлицыРодительскогоЭлемента     = Цел(КодРодительскогоЭлемента / киМаскаУлицы())% 10000;
...
Процедура РегистрСведенийСписокПриАктивизацииСтроки(Элемент)
	...
	Если Элемент.ТекущиеДанные.Код > 0 Тогда
		ЭлементыФормы.НадписьРодителей.Заголовок = киПолучитьПолноеНазвание(Элемент.ТекущиеДанные.Код);
...
Процедура КнопкаОКНажатие(Элемент)
	...
	Если ЗначениеЗаполнено( ЭлементыФормы.РегистрСведенийСписок.ТекущаяСтрока ) Тогда
		
		ОповеститьОВыборе(ЭлементыФормы.РегистрСведенийСписок.ТекущаяСтрока);
