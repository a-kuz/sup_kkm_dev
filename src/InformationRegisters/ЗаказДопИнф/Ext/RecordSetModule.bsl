...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	КонецЕсли;
	ЗарегистрироватьСобытие("Ловушка.РегистрСведений.ЗаказДопИнф", ПредопределенноеЗначение("УровеньЖурналаРегистрации.Примечание"),, ЗаказОтбор, ЛояльностьКлиентСервер.СформироватьJSON(ЭтотОбъект.Выгрузить()));
