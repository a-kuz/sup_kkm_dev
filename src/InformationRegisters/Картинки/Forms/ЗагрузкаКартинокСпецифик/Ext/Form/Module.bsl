...
Процедура ВыполнитьЗагрузку(Команда)
	...
	НачатьПоискФайлов(Новый ОписаниеОповещения("ПослеПоискаФайлов", ЭтотОбъект, ДополнительныеПараметры), КаталогСКартинками, "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]*.png", Истина);
...
Процедура ЗаполнитьСписокНайденнымиФайлами(НайденныеФайлы)
	...
	Для каждого ТекФайл Из НайденныеФайлы Цикл
		ИмяБезРасширения = ТекФайл.ИмяБезРасширения;
