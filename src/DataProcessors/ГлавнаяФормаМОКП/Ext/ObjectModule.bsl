...
Процедура ОформлениеСтрокиЗаказа(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ЦветВыделеннойСтандарт = Новый Цвет(ЦВ.Красный - 35, ЦВ.Зеленый - 35, ЦВ.Синий - 35);
	...
	Если СтрокаТекТовара = ДанныеСтроки Или (ДанныеСтроки.Уровень() И СтрокаТекТовара = ДанныеСтроки.Родитель) Тогда
		Для Каждого Ячейка Из ОформлениеСтроки.Ячейки Цикл
			Если Ячейка = ЯчейкаСтатус Тогда
				...
				Иначе
					ЦветВыделенной = Новый Цвет(ЯчейкаСтатус.ЦветФона.Красный - 35, ЯчейкаСтатус.ЦветФона.Зеленый - 35, ЯчейкаСтатус.ЦветФона.Синий - 35);		
				КонецЕсли;
			ИначеЕсли	Ячейка = ЯчейкаСумма Тогда
				...
				Иначе                                    					
					ЦветВыделенной = Новый Цвет(ЯчейкаСумма.ЦветФона.Красный - 35, ЯчейкаСумма.ЦветФона.Зеленый - 35, ЯчейкаСумма.ЦветФона.Синий - 35);
				КонецЕсли;
