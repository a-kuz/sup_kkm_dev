...
Функция ФирмаПоТовару(Товар)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.МестаРеализации КАК МестаРеализации
	|		ПО Фирмы.МестоРеализации = МестаРеализации.Ссылка
	|ГДЕ
	|	МестаРеализации.ОсновнойКаталогТоваров = &ВидМеню
	|	И Фирмы.ИнформационнаяБаза = &ИнформационнаяБаза
