...
Процедура ОформлениеСтрокиЗаказа(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	ЦветВыделенной = Новый Цвет(ЦВ.Красный - 35, ЦВ.Зеленый - 35, ЦВ.Синий - 35);
	...
	Если ЭлементыФормы.тпТовары.ТекущаяСтрока = ДанныеСтроки Тогда
...
Процедура ИнициализацияРеквизитов()
	...
	ЦветДозаказ		= ЦветаСтиля.ЦветДозаказ;
	ЦветЗаказано 	= ЦветаСтиля.ЦветЗаказано;
	ЦветГотово 		= ЦветаСтиля.ЦветГотово;
