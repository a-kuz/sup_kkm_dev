...
Функция ПоказатьИнформациюОтоваре(РежимПредпросмотра = Ложь) Экспорт
...
Функция ВводНовойСтроки(ВыбТов, Количество = 0, ШК = "", НельзяОтказатьсяОтВводаПозиции = Ложь, ИдСвязаннойСтроки = "", ОбязательнаяСпецифика = Неопределено, МинКоличествоСпецифики = 0) Экспорт
	...
	Попытка
		Если ГлавнаяФорма.РежимПредпросмотра И НЕ ПоказатьИнформациюОтоваре(ГлавнаяФорма.РежимПредпросмотра) = "ДОБАВИТЬ" Тогда
