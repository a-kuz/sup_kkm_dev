...
Перем ИнтервалОбновленияИнтерфейса; //
#КонецОбласти
...
Процедура тпТоварыПриАктивизацииСтроки(Элемент)
	...
	ОтключитьОбработчикОжидания("тпТоварыПриАктивизацииСтроки_Ожидание");
	ПодключитьОбработчикОжидания("тпТоварыПриАктивизацииСтроки_Ожидание", 0.2, Истина);
	
КонецПроцедуры

Процедура тпТоварыПриАктивизацииСтроки_Ожидание() Экспорт
...
//	Если Задержка Тогда
//		ОтключитьОбработчикОжидания("УстановитьТекСтроку_Ожидание");
//		ПодключитьОбработчикОжидания("УстановитьТекСтроку_Ожидание", Задержка, Истина);
//	Иначе
//		УстановитьТекСтроку_Ожидание();
//	КонецЕсли;
//КонецПроцедуры

//Процедура УстановитьТекСтроку_Ожидание() Экспорт 
...
ИнтервалОбновленияИнтерфейса = 0.5;
#КонецОбласти
