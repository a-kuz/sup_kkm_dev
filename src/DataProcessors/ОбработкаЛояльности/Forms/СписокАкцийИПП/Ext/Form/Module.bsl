...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = Параметры.ЗаголовокСтанции + ?(ПроектФильтр, " в " + ЛояльностьКлиентСерверПовтИсп.МестоРеализацииПоПроекту(ПроектФильтр, Истина, 3), "") + ":";
...
Функция СформироватьТабДокПП(КупоныГостя)
	...
	ОблМакета.Параметры.Заголовок = Параметры.ЗаголовокГостя + ?(ПроектФильтр, " в " + ЛояльностьКлиентСерверПовтИсп.МестоРеализацииПоПроекту(ПроектФильтр, Истина, 3), "") + ":";
	...
	ПоследнийКупон = ВыведеноКупонов % КоличествоЭлементовВСтроке;
