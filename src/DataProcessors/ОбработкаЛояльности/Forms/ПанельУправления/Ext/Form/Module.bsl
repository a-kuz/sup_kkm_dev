...
&НаСервере
Процедура КомандаОчисткаДанныхЛояльностиПоЗаказуНаСервере()
	Лояльность.ОчисткаДанныхЛояльностиПоЗаказу(ОчисткаДанных_Дата);
КонецПроцедуры

&НаКлиенте
Процедура КомандаОчисткаДанныхЛояльностиПоЗаказу(Команда)
	КомандаОчисткаДанныхЛояльностиПоЗаказуНаСервере();
КонецПроцедуры

&НаСервере
Процедура КомандаОчисткаСПУЛаНаСервере()
	Лояльность.ОчисткаДанныхСПУЛа(ОчисткаДанных_Дата);
КонецПроцедуры

&НаКлиенте
Процедура КомандаОчисткаСПУЛа(Команда)
	КомандаОчисткаСПУЛаНаСервере();
КонецПроцедуры
