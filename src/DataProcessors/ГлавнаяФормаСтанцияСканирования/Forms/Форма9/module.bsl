...
Процедура тпТоварыВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	ПоказатьИнформациюОтоваре(Элемент.ТекущиеДанные.Товар, Элемент.ТекущиеДанные.Цена,  Элемент.ТекущиеДанные.КГЛ);
КонецПроцедуры
...
Функция ПоказатьИнформациюОтоваре(Товар, Цена, КГЛ) Экспорт
