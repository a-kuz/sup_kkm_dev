...
Функция ОбработкаОплаты_Оплата(Фирма, КОплате) Экспорт
	...
	ЗаписьЖурналаРегистрации("Оплата.Вход в процедуру оплаты", УровеньЖурналаРегистрации.Информация, , Заказ.Ссылка, СтрШаблон("Фирма: %1, К оплате: %2", Фирма, КОплате));
	...
	ЗаписьЖурналаРегистрации("Оплата.Обработка лояльности.Начало", УровеньЖурналаРегистрации.Информация, , Заказ.Ссылка, СтрШаблон("ДанныеЛояльности: %1", ДанныеЛояльности));
	...
	Если НЕ ДанныеЛояльностиСтруктура = Неопределено Тогда
		...
		КонецЕсли;
	КонецЕсли;
	ЗаписьЖурналаРегистрации("Оплата.Обработка лояльности.Окончание", УровеньЖурналаРегистрации.Информация, , Заказ.Ссылка);
