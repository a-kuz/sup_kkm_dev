...
//УДАЛИТЬ		ВывестиИнформациюПоМестамРеализации();
...
//ТипТТ	ИначеЕсли МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан") Тогда	
...
Процедура ОжиданиеНачалоОплаты()
	...
	Если Открыта() Тогда
		...
		Если НЕ флОплатаВПроцессе Тогда
			СекундОжидать = 2;
			Если РабочееМесто.Фирма.ТипТТ = ПредопределенноеЗначение("Справочник.ТипыТТ.КМ") Тогда
//ТипТТ			Если РабочееМесто.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.КМ") Тогда
				СекундОжидать = 0.1;
			КонецЕсли;
