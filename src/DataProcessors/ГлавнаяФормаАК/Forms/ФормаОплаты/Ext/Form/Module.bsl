...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбновитьОтображениеСостоянияОплаты(РабочееМесто.МестоРеализации, РабочееМесто.Фирма.ТипТТ, ЭтаФорма);
...
Процедура ОбновитьОтображениеСостоянияОплаты(МестоРеализации, ТипТТ = Неопределено, Форма)
	
	Элементы = Форма.Элементы;
	МестаРеализации = Форма.МестаРеализации;
	флОплатаВПроцессе = Форма.флОплатаВПроцессе;
	...
	Если флОплатаВПроцессе Тогда
		...
		ОбновитьТабДокСписокОплаты(ТипТТ, Форма);
...
//&НаСервере
&НаКлиентеНаСервереБезКонтекста
Процедура ОбновитьТабДокСписокОплаты(ТипТТ, Форма)
	
	СостояниеОплаты = Форма.СостояниеОплаты;
	МестаРеализации = Форма.МестаРеализации;
