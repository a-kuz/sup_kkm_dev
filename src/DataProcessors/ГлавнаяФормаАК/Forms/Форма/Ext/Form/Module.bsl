...
//ТЧЛ1		И ЗначениеЗаполнено(НомерКартыЛояльности)
	...
	ПараметрыФормы.Вставить("ТаблицаТовары", СформироватьТоварыДляПередачи(, "Товар,Количество,фАлкоголь,МестоРеализации,КОплате,action_group,Цена,Наименование,Фирма,ККМ"));
...
//ТЧЛ1		КонецЕсли;
		...
		ПараметрыФормы.Вставить("СписаниеОплата", СписаниеОплата);
		ПараметрыФормы.Вставить("СписаниеСписание", СписаниеСписание);
		ПараметрыФормы.Вставить("ТаблицаТовары", СформироватьТоварыДляПередачи(Фирма, "Товар,Количество,фАлкоголь,МестоРеализации,КОплате,action_group,Цена,Наименование,Фирма,ККМ"));
		ПараметрыФормы.Вставить("ПоказатьТаблицуТовары", Истина);
		ПараметрыФормы.Вставить("ИдентификаторЛояльности", ИдентификаторЛояльности);
