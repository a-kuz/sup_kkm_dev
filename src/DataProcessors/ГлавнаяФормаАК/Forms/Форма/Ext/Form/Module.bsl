...
//ТипТТ		Если глРабочееМесто.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан") Тогда
...
//ТипТТ		Если глРабочееМесто.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан") Тогда
	...
	Если глРабочееМесто.Тип = Перечисления.ТипыРМ.Автокасса
		И глПараметрыРМ.ТипТТ = ПредопределенноеЗначение("Справочник.ТипыТТ.Ресторан") Тогда
//ТипТТ		И глПараметрыРМ.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан") Тогда
...
//ТипТТ	Если МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан") Тогда
...
//ТипТТ	ИначеЕсли МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.КМ") Тогда 	
...
Процедура ОбрабокаЗакрытияФормыВыборСпособаОплаты(Результат, ДополнительныеПараметры) Экспорт 
	...
	Иначе
		...
		ПараметрыФормы = Новый Структура("НомерТелефона,Email,РабочееМесто,ДекорацияКеглиРубли,ПодвалКеглиРубли", НомерТелефона, Email, глРабочееМесто, Результат.ДекорацияКеглиРубли, Результат.ПодвалКеглиРубли); 		
...
//ТипТТ		СтруктураОшибки.Вставить("ПараметрШаблона1", ?(глПараметрыРМ.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.Ресторан"), "ресторан", "магазин"));
	Исключение
...
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.Ширина = 0;
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.Высота = 0;
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.РазмерКартинки = РазмерКартинки.РеальныйРазмер;
...
//ТипТТ	Если МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.КМ") Тогда
		...
		// СтраницаЗавершение_6
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.Ширина = 19;
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.Высота = 2;
//УДАЛИТЬ		Элементы.ЛогоККГурмэ2.РазмерКартинки = РазмерКартинки.Растянуть;
...
Процедура ЗаписатьЗаказ(Статус, Заказ)
	...
	Если Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказа.Закрыт") Тогда
		Если глПараметрыРМ.ТипТТ = ПредопределенноеЗначение("Справочник.ТипыТТ.КМ") Тогда
//ТипТТ		Если глРабочееМесто.МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.КМ") Тогда
