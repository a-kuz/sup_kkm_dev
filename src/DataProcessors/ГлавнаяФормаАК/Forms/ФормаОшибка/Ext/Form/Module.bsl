...
#Если ТолстыйКлиентУправляемоеПриложение Тогда
	ЗарегистрироватьСобытие("Автокасса.Сообщение об ошибке", УровеньЖурналаРегистрации.Предупреждение, , ,ТекстОшибки1 + Символы.ПС + ТекстОшибки2);
#КонецЕсли 	
...
//ТипТТ	Если МестоРеализации = ПредопределенноеЗначение("Справочник.МестаРеализации.КМ") Тогда
		...
		// шапка
//УДАЛИТЬ		Элементы.ЛогоККГурмэ.Видимость = Истина;
