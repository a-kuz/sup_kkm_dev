...
Процедура ПриОткрытии(Отказ)
	...
	Если ВРег(РезультатКнопкиОК) = "ОШИБКАЗАПУСКА" ИЛИ ВРег(РезультатКнопкиОК) = "ЗАКРЫТЬПРИЛОЖЕНИЕ" Тогда
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если Открыта() И ИмяСобытия = "ГлавнаяФормаАК_СервисноеМеню_Закрытие" Тогда
