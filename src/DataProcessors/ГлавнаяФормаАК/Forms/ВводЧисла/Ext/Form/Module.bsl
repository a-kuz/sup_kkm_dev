...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	////		|этот номер
	////		|телефона";
	////	Элементы.КнопкиПодвала.Видимость = Ложь;
	...
	////	и РабочееМесто.МестоРеализации = Справочники.МестаРеализации.Ресторан Тогда
...
Процедура ОбновитьОтображениеЭлементовДляМестаРеализации(МестоРеализации)
	...
	Элементы.ПолучитьПИН.Видимость = Ложь; //TODO
