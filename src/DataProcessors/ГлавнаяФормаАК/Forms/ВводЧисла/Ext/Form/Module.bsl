...
//УДАЛИТЬ		Элементы.ЛогоККГурмэ.РазмерКартинки = РазмерКартинки.РеальныйРазмер;
		...
		Элементы.ПодвалКеГЛиРубли.Видимость = Ложь;
...
//УДАЛИТЬ		Элементы.Назад.Заголовок = "НАЗАД";
		...
		Элементы.ДекорацияКеглиРубли.Заголовок = Параметры.ДекорацияКеглиРубли;
		Элементы.ДекорацияКеглиРубли.Видимость = Ложь;
		
		Элементы.ПодвалКеГЛиРубли.Видимость = Истина;
	...
	Если ВидРезультата = 0 Тогда
		...
		Элементы.ПодтвердитьВыбор.Заголовок = "Отправить на
			|этот номер
			|телефона";
//УДАЛИТЬ		Элементы.КнопкиПодвала.Видимость = Ложь;
//УДАЛИТЬ		Элементы.Назад.Видимость = Истина;
	ИначеЕсли ВидРезультата = 1 Тогда
		// ПИН
...
//УДАЛИТЬ	Элементы.ПолучитьПИН.Видимость = Ложь; //TODO
