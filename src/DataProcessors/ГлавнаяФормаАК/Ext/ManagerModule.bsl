...
Процедура ПечатьПодвалаЛояльности(Фирма = Неопределено, ККМСсылка, ЗаказСсылка, ПротоколРасчетовСсылка = Неопределено) Экспорт 
	...
	ЗаписьЖурналаРегистрации("Оплата.ПечатьПодвалаЛояльности.До вызова", УровеньЖурналаРегистрации.Информация, , ЗаказСсылка);//Заказ.Ссылка);
	...
	ЗаписьЖурналаРегистрации("Оплата.ПечатьПодвалаЛояльности.После вызова", УровеньЖурналаРегистрации.Информация, , ЗаказСсылка);//Заказ.Ссылка);
