...
Функция ИнициализацияРабочегоМеста(ТекущееРМ) Экспорт
	...
	глПараметрыРМ.Вставить("ЭтоОтдохни", Ложь); // глПараметрыРМ.Фирма.МестоРеализации = Справочники.МестаРеализации.Отдохни);
...
Функция ОткрытьКассовуюСмену() Экспорт
	...
	РезультатПроверки = ПроверкаНаличияОткрытыхСмен();
...
Функция ПроверкаНаличияОткрытыхСмен()
	
	СтруктураОшибки = Новый Структура;
	
	мМестаРеализации = Новый Массив;
	Для каждого ТекФирма Из глПараметрыРМ.ФирмыРМ Цикл
		мМестаРеализации.Добавить(ТекФирма.МестоРеализации);
	КонецЦикла;
	
	Запрос = Новый Запрос;
	
	Запрос.УстановитьПараметр("МестоРеализации",	мМестаРеализации);	 //
	...
	Иначе
		...
		СтруктураОшибки.Вставить("РезультатКнопкиОК", "СервисноеМеню");
