...
Функция Сторно(НомерСтроки = 0) Экспорт 
	...
	Если КоличествоСтрок = 1 И Заказ.Товары.Найти(1, "СтатусОплаты") = Неопределено Тогда		
		СторноВсе();
...
//УДАЛИТЬ	ЛояльностьДанныеЗаказа = ИнтерфейсРМЛояльность.ОбновитьТовары(ГлавнаяФорма);
//УДАЛИТЬ	ИнтерфейсРМЛояльность.ОбновитьНадписьПриветствие(ГлавнаяФорма);
//УДАЛИТЬ	ИнтерфейсРМЛояльность.ОбновитьКупоны(ГлавнаяФорма,,ЛояльностьДанныеЗаказа);
//УДАЛИТЬ	ИнтерфейсРМЛояльность.ОбновитьТабДокЛояльность(ГлавнаяФорма,,ЛояльностьДанныеЗаказа);
