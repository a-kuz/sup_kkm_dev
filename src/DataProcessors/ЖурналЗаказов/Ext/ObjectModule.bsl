...
Процедура СоздатьСтруктуруЖурнала() Экспорт
	...
	ИначеЕсли НЕ СводныйЖурнал И НЕ ДоставкаЖурнал Тогда
		...
		Если глПараметрыРМ.ТипТТ = Справочники.ТипыТТ.МОКП Тогда
			ЖурналЗаказов.Колонки.Добавить("СуммаМЪ",ПолучитьОписаниеТиповЧисла(12,2),"МЪ",6);
			ЖурналЗаказов.Колонки.Добавить("СуммаО",ПолучитьОписаниеТиповЧисла(12,2),"О",6);
			ЖурналЗаказов.Колонки.Добавить("СуммаКП",ПолучитьОписаниеТиповЧисла(12,2),"КП",6);
		Иначе
