...
Процедура СоздатьСтруктуруЖурнала() Экспорт
	...
	ИначеЕсли НЕ СводныйЖурнал И НЕ ДоставкаЖурнал Тогда
		...
		ЖурналЗаказов.Колонки.Добавить("Время",,"Время создания",5);
		
		
		ЖурналЗаказов.Колонки.Добавить("Номер",,"Заказ №",8);
		ЖурналЗаказов.Колонки.Добавить("НомерКартыЛояльности",,"Карта Кегельбум",8);
		...
		Если глПараметрыРМ.ТипТТ = Справочники.ТипыТТ.МОКП Тогда
			ЖурналЗаказов.Колонки.Добавить("СуммаМЪ",ПолучитьОписаниеТиповЧисла(12,2),"МясновЪ",5);
			ЖурналЗаказов.Колонки.Добавить("СуммаО",ПолучитьОписаниеТиповЧисла(12,2),"Отдохни",5);
