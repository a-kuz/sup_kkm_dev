...
Процедура СоздатьСтруктуруЖурнала() Экспорт
	...
	ИначеЕсли НЕ СводныйЖурнал И НЕ ДоставкаЖурнал Тогда
		...
		ЖурналЗаказов.Колонки.Добавить("НомерКарты",,"Бейдж",8);
		...
		ЖурналЗаказов.Колонки.Добавить("ВремяПоследнейАктивности",,,6);
		ЖурналЗаказов.Колонки.Добавить("МестоПоследнейАктивности",,,6);
