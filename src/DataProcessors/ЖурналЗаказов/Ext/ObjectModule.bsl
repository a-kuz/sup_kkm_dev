...
Процедура СоздатьСтруктуруЖурнала() Экспорт
	...
	ИначеЕсли НЕ СводныйЖурнал И НЕ ДоставкаЖурнал Тогда
		...
		ЖурналЗаказов.Колонки.Добавить("Время",,"Время создания",6);
		
		
		ЖурналЗаказов.Колонки.Добавить("Номер",,"Заказ №",8);
		ЖурналЗаказов.Колонки.Добавить("НомерКартыЛояльности",,"Карта Кегельбум",10);
		ЖурналЗаказов.Колонки.Добавить("НомерКарты",,"Бейдж №",4);
		ЖурналЗаказов.Колонки.Добавить("Пейджер",ПолучитьОписаниеТиповЧисла(2,0),"Пейджер",5);
		ЖурналЗаказов.Колонки.Добавить("Приготовление",ПолучитьОписаниеТиповЧисла(2,0),"Готовится",5);
		ЖурналЗаказов.Колонки.Добавить("КВыдаче",ПолучитьОписаниеТиповЧисла(2,0),"К выдаче",5);
		...
		Если глПараметрыРМ.ТипТТ = Справочники.ТипыТТ.МОКП Тогда
			ЖурналЗаказов.Колонки.Добавить("СуммаМЪ",ПолучитьОписаниеТиповЧисла(12,2),"МЪ",5);
			ЖурналЗаказов.Колонки.Добавить("СуммаО",ПолучитьОписаниеТиповЧисла(12,2),"О",5);
			ЖурналЗаказов.Колонки.Добавить("СуммаКП",ПолучитьОписаниеТиповЧисла(12,2),"КП",5);
		Иначе
...
Процедура ОбновитьСтатистику() Экспорт
	...
	|		ПО ОткрытыеЗаказыПоКартам.КартаДоступа = ЗаказТовары.Ссылка
	|ГДЕ
