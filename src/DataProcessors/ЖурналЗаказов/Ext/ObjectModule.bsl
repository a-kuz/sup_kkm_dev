...
Процедура СоздатьСтруктуруЖурнала() Экспорт
	...
	ИначеЕсли НЕ СводныйЖурнал И НЕ ДоставкаЖурнал Тогда
		...
		ЖурналЗаказов.Колонки.Добавить("Номер",,"Заказ №",7);
		...
		Если глПараметрыРМ.ТипТТ = Справочники.ТипыТТ.МОКП Тогда
			ЖурналЗаказов.Колонки.Добавить("СуммаМЪ",ПолучитьОписаниеТиповЧисла(12,2),"МясновЪ",6);
			ЖурналЗаказов.Колонки.Добавить("СуммаО",ПолучитьОписаниеТиповЧисла(12,2),"Отдохни",6);
