...
Процедура КнопкиИнициализацияНастройки() Экспорт
	...
	КонецПопытки;
	ШиринаВнутреннейОбласти = мин(КнопкаДляОпределенияРазмера.Ширина,ФормаПодбора.Ширина-10);
	ВысотаВнутреннейОбласти = мин(КнопкаДляОпределенияРазмера.Высота,ФормаПодбора.Высота-45);
	ЭлементыФормы.Очистить();	
