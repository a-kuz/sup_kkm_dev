...
Процедура ПриОткрытии()
	...
	Если ЗначениеЗаполнено(товар.Номенклатура.СБ_СодержаниеБелков) тогда
		...
		КонецЕсли;
		стрЭнергетика = стрЭнергетика + Символы.ПС;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(товар.Номенклатура.СБ_СодержаниеККАЛ) тогда
		Если Выход = 0 тогда //на 100гр
			стрЭнергетика = стрЭнергетика + "Энерг. ценность:      "+Формат(Товар.Номенклатура.СБ_СодержаниеККАЛ,"ЧЦ=6; ЧДЦ=2")+" ккал на 100 г.";
		иначе //на вес штуки (порции)
			стрЭнергетика = стрЭнергетика + "Энерг. ценность:      "+Формат(Товар.Номенклатура.СБ_СодержаниеККАЛ*Выход/100,"ЧЦ=6; ЧДЦ=2")+" ккал";
		КонецЕсли;
	КонецЕсли;
