	...
	Если ФормаПодбораТоваров.ПараметрыНастройки.ПоложениеОкна = "Низ" Тогда
		...
		Если ФормаПодбораТоваров.ПараметрыНастройки.СвободноеОкно Или Истина Тогда
			...
			Иначе
				...
				ЭлементФормыТаблицаВозврат.Высота	= ЭлементФормыТаблицаВозврат.Высота - ФормаПодбораТоваров.ПараметрыОкна.Высота;
				ЭлементФормыТаблицаЗаказаТень.Высота	= ЭлементФормыТаблицаЗаказаТень.Высота - ФормаПодбораТоваров.ПараметрыОкна.Высота;
			КонецЕсли;
		Иначе
