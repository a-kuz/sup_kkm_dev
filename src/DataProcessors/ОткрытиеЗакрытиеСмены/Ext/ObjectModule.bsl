...
Функция ЗакрытьСмену(МассивОшибок = Неопределено) Экспорт
	...
	Иначе
		...
		ФормированиеОтчетовФО.СформироватьОтчеты(ДокОткрытияСмены.МестоРеализации,Ложь);
...
Процедура ВыгрузкаДанных()
	...
	СписокСформированныхДокументов = ФормированиеОтчетовФО.СформироватьОтчеты( глПараметрыРМ.МестоРеализации, Ложь );
