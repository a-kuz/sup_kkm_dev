...
Процедура ИнициализацияРеквизитов()
	...
	МассивДействий.Добавить("ВыбратьРецептГостя", 		"ДОБАВИТЬ БЛЮДО ПО РЕЦЕПТУ ГОСТЯ");
	МассивДействий.Добавить("РедактироватьРецептГостя", "РЕДАКТИРОВАНИЕ РЕЦЕПТОВ ГОСТЯ");
	МассивДействий.Добавить("СохранитьРецептГостя", 	"ДОБАВИТЬ НОВЫЙ РЕЦЕПТ ГОСТЯ");
