...
Функция СохранитьРецептГостя()
	...
	Иначе
		Возврат "Создан рецепт INSPIRED <" + ДокРецепт.ИмяРецепта+"> для "+Блюдо;
	КонецЕсли;
...
Функция ВыбратьВыполнитьДействие(ВыбранноеДействие = "") Экспорт 
	
	Результат = ПолучитьСтруктуруРезультата();
	Если ВыбранноеДействие = "" Тогда
...
Процедура ИнициализацияРеквизитов()
	...
	МассивДействий.Добавить("СохранитьРецептГостя", 	"СОЗДАТЬ НОВЫЙ РЕЦЕПТ ГОСТЯ INSPIRED");
	МассивДействий.Добавить("р1", 	"=======================================");
	МассивДействий.Добавить("РедактироватьРецептГостя", "РЕДАКТИРОВАТЬ РЕЦЕПТЫ ГОСТЯ");
	МассивДействий.Добавить("р2", 	"=======================================");
	МассивДействий.Добавить("ВыбратьРецептГостя", 		"ВЫБРАТЬ РЕЦЕПТ ГОСТЯ INSPIRED");
