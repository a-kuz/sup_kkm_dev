...
Процедура ОбновитьОчередьМарок()
	...
	|  ТоварыЗаказа.НомерСтроки,ЗаказДопИнф.Номерок,
	...
	|	СписокТоваров.Товар,
	|	Максимум(СписокТоваров.НомерСтроки) НомерСтроки,
	|	СписокТоваров.Количество,
	|	СписокТоваров.КоличествоУдалено,
	|	СписокТоваров.ИдСтрокиВладельца,
	|	СписокТоваров.НомерМарки,
	|	СписокТоваров.ВремяМаркиГр, Порядок из (
	|ВЫБРАТЬ
	|	СписокТоваров.Заказ,
	|	СписокТоваров.Номерок Номерок,
	|	СписокТоваров.ИдСтроки,
	|	СписокТоваров.ВремяДозаказ,
	|	СписокТоваров.ВремяЗаказано,
	|	СписокТоваров.ВремяГотово,
	...
	//Z-
	|ИЗ
	|	СписокТоваров КАК СписокТоваров  где ИдСтрокиВладельца = """"
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
