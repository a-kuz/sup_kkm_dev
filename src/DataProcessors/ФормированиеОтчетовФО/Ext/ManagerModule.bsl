Функция ТаблицаОперативнойРеализации(Смена, ЧислаЧислами = 0, Фирма = Неопределено) Экспорт
	...
	Если Фирмы.Количество() Тогда			
		Если Справочники.МестаРеализации.КМ = Смена.МестоРеализации ИЛИ Фирма.ТипТТ = Справочники.ТипыТТ.КМ или Фирма.ТипТТ = Справочники.ТипыТТ.МОКП Тогда
