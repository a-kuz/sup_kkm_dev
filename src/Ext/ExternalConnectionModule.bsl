...
#Если ВнешнееСоединение Тогда
	...
	Функция ЗарегистрироватьРезультатТестирования(КодИБ, ПрофильВхода, стрРезультат) Экспорт
		ЗаписьЖурналаРегистрации("Получение результата тестирования РМ", УровеньЖурналаРегистрации.Информация, , , ПрофильВхода + Символы.ПС + стрРезультат);
	...
	Функция ВыполнитьОбменПоНастройкеXML(ДатаНачала=Неопределено, ДатаОкончания=Неопределено) Экспорт
		ЗаписьЖурналаРегистрации("ВыполнитьОбменПоНастройкеXML");
		Попытка
		...
		КонецПопытки;
		ЗаписьЖурналаРегистрации("ВыполнитьОбменПоНастройкеXML.Конец",,,,ЗначениеВСтрокуВнутр(Результат));
		Возврат Результат;
