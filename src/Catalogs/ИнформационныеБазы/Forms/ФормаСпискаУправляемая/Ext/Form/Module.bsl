...
Процедура ЗапуститьТонкийКлиент(Команда)
	...
	ЗапуститьПриложение(СтрШаблон("%2 ENTERPRISE /IBConnectionString""Srvr=""""%1:%3"""";Ref=""""sup_kkm"""";"" /WA- /N""Администратор"" /P19643003 /DisplayAllFunctions /RunModeManagedApplication /itaxi /OLow /TComp", 
