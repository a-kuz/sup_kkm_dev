...
Процедура ПриОткрытии()
	...
	Если ТолькоПросмотр Тогда
		ЭлементыФормы.ДействияФормы.Кнопки.ЗагрузитьКурсы.Доступность = Ложь;
...
//
Процедура СправочникСписокВалютыПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
