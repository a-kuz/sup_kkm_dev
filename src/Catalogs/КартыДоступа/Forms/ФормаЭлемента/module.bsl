...
Процедура ОбновлениеОтображения()
	...
	ЭлементыФормы.ОдноразовоеИспользование.Видимость = ЭтоШаблон;
...
Процедура ИдентификаторНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить("%"	, "% : произвольная последовательность символов");
	СписокВыбора.Добавить("_"	, "_ : один произвольный символ");
	СписокВыбора.Добавить("[…]"	, "[…] : любой одиночный символ из перечисленных");
	СписокВыбора.Добавить("[^…]", "[^…] : любой символ, кроме перечисленных");
	
	ВыбЭлемент = ВыбратьИзСписка(СписокВыбора);
	Если ВыбЭлемент<>Неопределено Тогда
		Элемент.Значение = Элемент.Значение + ВыбЭлемент.Значение;
	КонецЕсли;
