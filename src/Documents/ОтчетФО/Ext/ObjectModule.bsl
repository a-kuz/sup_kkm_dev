...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	Товары.Свернуть("ШК, Номенклатура, ЕдиницаИзмерения, Контрагент, ВариантОплаты, Идентификатор, ККМ, КассоваяСмена, СтавкаНДС", "Количество, Сумма, СуммаБезСкидки, СуммаБонусов, СуммаНДС, СуммаКорр");
