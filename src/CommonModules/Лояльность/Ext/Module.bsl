...
Функция ПолучитьПревьюЗаказа(ЗаказСсылка, ВерсияДанных) Экспорт
	...
	Для каждого ТекущееСоответствие Из СоответствиеИтогов Цикл
		ТекущиеКГЛ = 0;
		Для каждого ТекущаяСтрока Из Данные.Итоги.КГЛИнфо Цикл
			Если ТекущееСоответствие.Ключ <> ТекущаяСтрока.ТипАкции Тогда
				Продолжить;
			КонецЕсли;
			ТекущиеКГЛ = ТекущиеКГЛ + ТекущаяСтрока.КГЛ;
		КонецЦикла;
		НовыеИтоги.Добавить(Новый Структура("Текст,КГЛ", ТекущееСоответствие.Значение, ТекущиеКГЛ));
		...
		Для каждого ТекущаяСтрока Из Данные.ИтогиМ.КГЛИнфо Цикл
			...
			ТекущиеКГЛ = ТекущиеКГЛ + ТекущаяСтрока.КГЛ;
		КонецЦикла;
		НовыеИтогиМ.Добавить(Новый Структура("Текст,КГЛ", ТекущееСоответствие.Значение, ТекущиеКГЛ));
		...
		Для каждого ТекущаяСтрока Из Данные.ИтогиО.КГЛИнфо Цикл
			...
			ТекущиеКГЛ = ТекущиеКГЛ + ТекущаяСтрока.КГЛ;
		КонецЦикла;
		НовыеИтогиО.Добавить(Новый Структура("Текст,КГЛ", ТекущееСоответствие.Значение, ТекущиеКГЛ));
		...
		Для каждого ТекущаяСтрока Из Данные.ИтогиКП.КГЛИнфо Цикл
			...
			ТекущиеКГЛ = ТекущиеКГЛ + ТекущаяСтрока.КГЛ;
		КонецЦикла;
		НовыеИтогиКП.Добавить(Новый Структура("Текст,КГЛ", ТекущееСоответствие.Значение, ТекущиеКГЛ));
	КонецЦикла;
