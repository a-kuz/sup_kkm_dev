...
Функция ПолучитьПревьюЗаказа(ЗаказСсылка, ВерсияДанных) Экспорт
	...
	Для ТипАкции = 1 По 6 Цикл
		...
		КонецЦикла;
		ТекстАкции = ТекстИтоговКассира.Получить(ТипАкции) + "|" + ТекстИтоговГостя.Получить(ТипАкции);
		НовыеИтоги.Добавить(Новый Структура("Текст,КГЛ", ТекстАкции, ТекущиеКГЛ));
		...
		КонецЦикла;
		ТекстАкции = ТекстИтоговКассира.Получить(ТипАкции) + "|" + ТекстИтоговГостя.Получить(ТипАкции);
		НовыеИтогиМ.Добавить(Новый Структура("Текст,КГЛ", ТекстАкции, ТекущиеКГЛ));
		...
		КонецЦикла;
		ТекстАкции = ТекстИтоговКассира.Получить(ТипАкции) + "|" + ТекстИтоговГостя.Получить(ТипАкции);
		НовыеИтогиО.Добавить(Новый Структура("Текст,КГЛ", ТекстАкции, ТекущиеКГЛ));
		...
		КонецЦикла;
		ТекстАкции = ТекстИтоговКассира.Получить(ТипАкции) + "|" + ТекстИтоговГостя.Получить(ТипАкции);
		НовыеИтогиКП.Добавить(Новый Структура("Текст,КГЛ", ТекстАкции, ТекущиеКГЛ));
	КонецЦикла;
