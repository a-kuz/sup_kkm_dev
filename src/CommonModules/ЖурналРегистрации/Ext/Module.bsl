...
Процедура ЗагрузитьЖРвЖР(Записей = 10000) Экспорт
	...
	ВыгрузитьЖурналРегистрации(ТЗ, Отбор, "Уровень,Дата,ИмяПользователя ,Компьютер,ПредставлениеСобытия,Комментарий,Данные,ПредставлениеПриложения,ПредставлениеДанных",,Записей);
