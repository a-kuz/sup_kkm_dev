...
Процедура ДействиеРецептыГостя(ГлавнаяФорма) Экспорт 
	...
	ИначеЕсли РезультатДействия.Свойство("СохранитьРецептГостя") И ЗначениеЗаполнено(РезультатДействия.РедактироватьРецептГостя) Тогда
		
		ИнтерфейсРМ.ВопросПредупреждение("Создание рецепта гостя...", РезультатДействия.РедактироватьРецептГостя, "", "Esc=OK", "", "");
