...
Процедура ПлашкаКупонНажатие(Форма, Элемент) Экспорт
	...
	Исключение
		ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Ошибка, , , "Купон:" + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	    Возврат;
	КонецПопытки;
	
	КодКупона = КупоныСоответствие.Получить(СтрЗаменить(Элемент.Имя, "Плашка", ""));
	
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , ЗаказСсылка, "Купон=" + КодКупона);
...
Процедура Плашка7Нажатие(Форма, Элемент)
	...
	Исключение
		ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Ошибка, , , "Плашка7:" + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	    Возврат;
	КонецПопытки;
	...
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , , "Купон=" + КодКупона);
...
Процедура Плашка8Нажатие(Форма, Элемент)
	...
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , "", "Плашка8");
...
Процедура Плашка9Нажатие(Форма, Элемент)
	...
	Попытка
		ЗаказСсылка = Форма.Заказ.Ссылка;
	Исключение
		ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Ошибка, , , "Плашка9:" + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	    Возврат;
	КонецПопытки;
	
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , ЗаказСсылка, "Плашка9");
...
Процедура Плашка10Нажатие(Форма, Элемент)
	...
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , , "Плашка10");
		
КонецПроцедуры
Процедура Плашка11Нажатие(Форма, Элемент)
	
	ЗарегистрироватьСобытие("Лояльность.Нажатие плашки", УровеньЖурналаРегистрации.Информация, , , "Плашка11");
