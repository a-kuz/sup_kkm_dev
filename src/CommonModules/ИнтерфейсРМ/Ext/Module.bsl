...
Функция ЗарегестрироватьСотрудникаВпоследних(Сотрудник) Экспорт
	...
	Если Позиция = 0 Тогда
		Возврат Истина;
	ИначеЕсли Позиция = Неопределено Тогда
		НовыйМассив.Добавить(Сотрудник);
		Для Каждого Т Из глПоследниеСотрудники Цикл
			Если НовыйМассив.Количество()<4 Тогда
				НовыйМассив.Добавить(Т);
			КонецЕсли;
		КонецЦикла;
	Иначе
		НовыйМассив.Добавить(Сотрудник);
		Для Каждого Т Из глПоследниеСотрудники Цикл
			Если НовыйМассив.Количество()<4 И Сотрудник<>Т Тогда
				НовыйМассив.Добавить(Т);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
	глПоследниеСотрудники.Очистить();
	ДополнитьМассив(глПоследниеСотрудники, НовыйМассив,Истина);
КонецФункции
