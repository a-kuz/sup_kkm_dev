...
Процедура УстановитьВерсиюЛояльности() Экспорт
	...
	Пока ВыборкаРМ.Следующий() Цикл
		ВерсияЛояльностиМестаРеализации = РегистрыСведений.ДополнительныеСвойства.ЗначениеСвойства(ВыборкаРМ.МестоРеализации, "Лояльность_Версия");
	...
	Если ВерсияЛояльности = "999" Тогда
