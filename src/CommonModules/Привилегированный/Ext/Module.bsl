...
Процедура УстановитьВерсиюЛояльности() Экспорт
	...
	|	РабочиеМеста.Фирма.ТипТТ КАК ТипТТ
	|ИЗ
	...
	Пока ВыборкаРМ.Следующий() Цикл
		ВерсияЛояльностиТипаТТ = РегистрыСведений.ДополнительныеСвойства.ЗначениеСвойства(ВыборкаРМ.ТипТТ, "Лояльность_Версия");
		
		Если ЗначениеЗаполнено(ВерсияЛояльностиТипаТТ) Тогда
			Если ВерсияЛояльности < ВерсияЛояльностиТипаТТ Тогда
				ВерсияЛояльности = ВерсияЛояльностиТипаТТ;
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
