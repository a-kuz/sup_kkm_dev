...
Функция УстановитьБлокировкуСоединений(ИнформационнаяБаза, БлокировкаСоединений = Истина, БлокировкаФоновыхЗаданий = Истина) Экспорт
	Соединитель = ИнформационнаяБаза.ПолучитьОбъект().ComConnection();
	Агент = Соединитель.ConnectAgent(ИнформационнаяБаза.СерверХост);
...
Процедура СоздатьФайловуюБазу(ИнформационнаяБаза) Экспорт
	...
	ОтключитьПолноТекстовыйПоиск(ИнформационнаяБаза);
...
Процедура ОтключитьПолноТекстовыйПоиск(ИнформационнаяБаза) Экспорт
	Com = ИнформационнаяБаза.ПолучитьОбъект().ComConnection();
	Com.ПолнотекстовыйПоиск.УстановитьРежимПолнотекстовогоПоиска(Com.РежимПолнотекстовогоПоиска.Запретить);	
КонецПроцедуры
